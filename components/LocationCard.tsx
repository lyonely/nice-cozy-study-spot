import { Card, Text, Group, Accordion } from '@mantine/core'
    ...
    return (
        ...
        >
            <Link href={name} passHref>
                <Group position="apart" direction="column" spacing="xs">
                    <Group>
                        {getIcon(name)}
...
function getIcon(name) {
    switch (true) {
        case name.includes('Library'):
            return <Books />
        case name.includes('Park'):
            return <Trees />
        case name.includes('School'):
            return <School />
        case name.includes('Lawn'):
            return <Flower />
        case name.includes('Hall'):
            return <Home />
        case name.includes('Hospital'):
            return <BuildingHospital />
        case name.includes('Huxley'):
            return <DeviceLaptop />
        default:
